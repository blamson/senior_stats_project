...
walkway_df %>%
    ...
    mutate(
        no_orient = any(
            mapply(
                function(n, s, e, w) vec_in_list(c(n,s,e,w), no_orient), 
                walkway_N, walkway_S, walkway_E, walkway_W
            )
        ),
        ns_dom = any(
            mapply(
                function(n, s, e, w) vec_in_list(c(n,s,e,w), ns_dom), 
                walkway_N, walkway_S, walkway_E, walkway_W
            )
        ),
        ew_dom = any(
            mapply(
                function(n, s, e, w) vec_in_list(c(n,s,e,w), ew_dom), 
                walkway_N, walkway_S, walkway_E, walkway_W
            )
        )
    ) %>%
